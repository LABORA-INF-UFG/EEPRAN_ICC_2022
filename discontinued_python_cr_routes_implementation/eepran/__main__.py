...
def main():
    link_path = 'topologies/power_test_topo_25_hier_links_2.json'
    link_anel_path = 'topologies/power_test_topo_25_anel_links.json'
    path_path = 'topologies/power_test_topo_25_hier_routes.json'
    path_anel_path = 'topologies/power_test_topo_25_anel_routes.json'
    ...
    core.path.find_paths(link_path, node1_path, path_path, is_ring_topology=False)
    core.path.find_paths(link_anel_path, node1_path, path_anel_path, is_ring_topology=True)

    text = ''

    time_start = time.time()
    model, bottleneck = core.model.build_eepran_model(link_path, node1_path, path_path, is_ring_topology=False)
